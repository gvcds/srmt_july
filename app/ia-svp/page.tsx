...
5. O resultado deve ser direto, profissional e 100% texto puro pronto para ser colado em um e-mail tradicional.`
 ...
 return (
 <div className={`${hasChart ? 'w-full' : 'max-w-[90%]'} group relative p-5 rounded-xl text-[15px] leading-relaxed shadow-sm transition-all duration-500 ${
 role === 'user' 
 ...
 emailStatus === 'processing' ? 'animate-pulse text-blue-500' :
